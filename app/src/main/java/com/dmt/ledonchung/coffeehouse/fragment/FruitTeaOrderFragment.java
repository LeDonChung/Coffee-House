...
public class FruitTeaOrderFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fruit_tea_order, container, false);
        initUI();
        getProductCoffee();
        return view;
    }
    ...
    public void getProductCoffee() {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("products/fruittea");
